...
function MeuPerfilScreen({ onNavigateToHome, onNavigateToForgotPassword }) {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            try {
                ...
                setProfileData({
                    telefone: formatPhone(response.data.telefone || ''),
    ...
    const handleProfileSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put('/users/me', dataToSend, { headers: { 'Authorization': `Bearer ${token}` } });
    ...
    if (loading && !profileData.telefone && !isPasswordFocused) return <div className="loading-message">Carregando perfil...</div>;
